...
public class HeartDiseaseIndicatorController {
    ...
    @RequestMapping(value = "/high-bp-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/high-chol-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/smoker-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/stroke-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/physical-activity-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/fruits-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/veggies-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/heavy-alcohol-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/any-healthcare-by-hd-positive", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/no-doc-cost-by-hd-positive", method = RequestMethod.GET)
